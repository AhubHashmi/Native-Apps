    ...
    return (
        <Background>
            <View style={{ marginHorizontal: 3.5, marginVertical: 100 }}>
                ...
                <Btn bgColor='black' textColor='gold' btnLabel="Home" Press={() => props.navigation.navigate("HookEffect")} />
                <Btn bgColor='black' textColor='gold' btnLabel="home" Press={() => props.navigation.navigate("home")} />
            </View>
        </Background>
        // <View>
        //     <HookEffect/>
